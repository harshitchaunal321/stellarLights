...
<div class="hero-section" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/our-story-home.png');">
    <div class="photo-credit-container">
        <div class="photo-credit">Mario Veloso</div>
    </div>
</div>
    ...
    <div class="container">
        <div class="shows-grid">
            ...
            <div class="show-item">
                ...
                <a href="/feature-shows" class="read-more">Read More</a>
            </div>
            <div class="show-item">
                <h3>First Lights</h3>
                <p>
                ...
                <a href="/first-lights" class="read-more">Read More</a>
            </div>
            <div class="show-item">
